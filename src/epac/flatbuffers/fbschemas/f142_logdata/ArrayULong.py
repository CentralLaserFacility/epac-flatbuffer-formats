...
def ArrayULongStart(builder: flatbuffers.Builder):
...
def ArrayULongAddValue(builder: flatbuffers.Builder, value: int):
...
def AddValue(builder: flatbuffers.Builder, value: int):
    ArrayULongAddValue(builder, value)


def ArrayULongStartValueVector(builder, numElems: int) -> int:
...
def ArrayULongEnd(builder: flatbuffers.Builder) -> int:
