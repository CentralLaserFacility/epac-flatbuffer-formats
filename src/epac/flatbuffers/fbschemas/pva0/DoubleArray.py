...
def DoubleArrayStart(builder: flatbuffers.Builder):
    builder.StartObject(1)


def Start(builder: flatbuffers.Builder):
    DoubleArrayStart(builder)


def DoubleArrayAddValue(builder: flatbuffers.Builder, value: int):
...
def AddValue(builder: flatbuffers.Builder, value: int):
    DoubleArrayAddValue(builder, value)


def DoubleArrayStartValueVector(builder, numElems: int) -> int:
...
def DoubleArrayEnd(builder: flatbuffers.Builder) -> int:
